...
// --- Example usage ---
// In your main App or GameSelector, call logDayPlayed() on mount:
  // import { logDayPlayed } from "./hooks/usePlayerStats";
  // useEffect(() => { logDayPlayed(); }, []);

// To log a game played:
  // logGamePlayed("gridironGrid");

// To log a social share:
  // logSocialShare("twitter");

// To get stats in a component:
  // const { totalDaysPlayed, currentStreak, gamesPlayedByType, platformsSharedTo } = usePlayerStats();