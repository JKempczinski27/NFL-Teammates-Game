    ...
    >
      ...
      <DialogContent sx={{ pt: 1 }}>
        <Typography variant="body1" paragraph>
          We use analytics to enhance your Long Drive gaming experience
          through performance tracking and personalization.
        </Typography>
            ...
            <Typography variant="body2" component="div">
              ...
              <Box sx={{ mt: 2 }}>
                <Typography variant="caption" color="text.secondary">
                  ...
                  <Link href="mailto:privacy@nfl-longdrive-game.com">
                    privacy@nfl-longdrive-game.com
                  </Link>
                </Typography>
              </Box>
            </Typography>
        ...
        <Box sx={{ mt: 3, p: 2, bgcolor: 'info.light', borderRadius: 1 }}>
          <Typography variant="body2" color="info.dark">
            <strong>🎮 Game Experience:</strong> Accepting analytics helps us make Long Drive
